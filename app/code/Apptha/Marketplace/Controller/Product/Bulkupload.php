    ...
    public function getCustomOptionValues($customOptions, $valueArr, $previousName, $customOptionsCount, $valueFlag, $valueFlagCount) {
        if ($valueArr [0] == 'name') {
            if ($valueArr [1] == $previousName && $customOptionsCount != 0) {
                ...
                /* Added so as to get custom options working while bulk upload on 24-01-2020*/
                $customOptions [$customOptionsCount] ['sort_order'] = 1;
                /* Commented so as to get custom options working while bulk upload on 24-01-2020*/
