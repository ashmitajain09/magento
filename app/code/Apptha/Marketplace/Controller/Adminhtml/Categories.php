...
use Apptha\Marketplace\Model\Category;
...
abstract class Categories extends Action {
    ...
    /**
     * Marketplace Categories access rights checking
     *
     * @return bool
     */
    protected function _isAllowed() {
        return $this->_authorization->isAllowed ( 'Apptha_Marketplace::manage_categories' );
    }
}
