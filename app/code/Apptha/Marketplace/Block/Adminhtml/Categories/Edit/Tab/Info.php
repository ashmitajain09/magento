 ...
 *
 * */
namespace Apptha\Marketplace\Block\Adminhtml\Categories\Edit\Tab;
...
/**
 * Class Contains Category Commission Functions
 */
class Info extends Generic implements TabInterface {
    ...
    protected function _prepareForm() {
        ...
        $model = $this->_coreRegistry->registry ( 'marketplace_category' );
