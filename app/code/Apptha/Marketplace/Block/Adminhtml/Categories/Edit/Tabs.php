 ...
 *
 * */
namespace Apptha\Marketplace\Block\Adminhtml\Categories\Edit;
...
class Tabs extends WidgetTabs {
    ...
    protected function _beforeToHtml() {
        $this->addTab ( 'Commission', [ 
                'label' => __ ( 'General' ),
                'title' => __ ( 'General' ),
                'content' => $this->getLayout ()->createBlock ( 'Apptha\Marketplace\Block\Adminhtml\Categories\Edit\Tab\Info' )->toHtml (),
                'active' => true 
        ] );
